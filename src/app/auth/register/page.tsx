...
import { Rocket, User, Mail, Lock, Phone, Globe, MapPin, Briefcase, FileText, Link2, Loader2, AlertTriangle } from "lucide-react";
...
export default function RegisterPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      alert(
        `🎉 Registration Successful!\n\nYour Email: ${json.data.email}\nYour Password: ${json.data.password}\n\n(Please save this password securely.)`
      );
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-7 backdrop-blur">
          ...
          <p className="mt-1.5 text-center text-sm text-zinc-500">
            Get started with UpRankly today
          </p>
